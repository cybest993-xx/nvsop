...
> Full breakdown (build flow, 7 post-build checks, auto-fix recipes; RTSP is an opt-in ds-sop-skills feature, requested at generation — § 18): [`references/ds-sop-building.md`](references/ds-sop-building.md)

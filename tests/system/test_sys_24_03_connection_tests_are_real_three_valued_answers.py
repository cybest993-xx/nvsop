...
def test_connection_tests_are_real_three_valued_answers(
    ...
    reached = client.post(f"{BACKENDS}/{reachable_id}/connection-test", headers=headers)
    ...
    failed = client.post(f"{BACKENDS}/{unreachable_id}/connection-test", headers=headers)
